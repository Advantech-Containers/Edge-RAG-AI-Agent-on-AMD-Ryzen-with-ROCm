...
echo "Connecting to container and starting services..."

docker exec -it Deepseek-R1-1.5B-Langchain-AI-Agent-RAG-on-AMD bash -c "cd langchain-service && chmod +x start_services.sh && ./start_services.sh; exec bash"
